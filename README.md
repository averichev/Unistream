...
**Оценочное время на выполнение:** 3–4 часа  
**Общее время:** 7 календарных дней с момента выдачи.  
**Требуется:** сделать **одно любое задание** из приложенных в архив на выбор.

**Результат:** отправить в чат Skype, где было выдано задание.  
Исходный код — архивом или ссылкой на публичный репозиторий (GitHub / GitLab и т. д.).
